...
2. Install Build Tools (MSYS2)

- Download and install [MSYS2](https://www.msys2.org/).
- During installation, ensure the binaries are added to the `PATH`. MSYS2 is essential for compiling the `pgmq` extension on Windows.
